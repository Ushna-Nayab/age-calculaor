    ...
    return (
        <>
            <div className='Container'>
             ...
             <p className=' para container_title'>The Age Calculator App can calculate the time difference between two dates, showing the result in years.</p>
             <div className='Container_middle'>
                ...
                Reset
                    ...
                    <div className='left'>
                        ...
                        <h1 className='age_details'>{age > 0 ? ` ${age}` : ''}</h1>
                    </div>
             </div>
            </div>
        </>
